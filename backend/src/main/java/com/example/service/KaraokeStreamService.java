...
public class KaraokeStreamService {
    ...
    public KaraokeStreamService() {
        ...
        songList.add(new Song(
                3, "Happy Day", "채리필터",
                """
                        난_내가_말야_스무살쯤엔_요절할_천재일줄만_알고
                        어릴_땐_말야_모든게_다_간단하다_믿었지
                        이제_나는_딸기향_해열제_같은_환상적인_해결책이_필요해
                        징그러운_일상에_불을_지르고
                        어디론가_도망갈까
                        찬란하게_빛나던_내_모습은_어디로_날아갔을까_어느_별로
                        작은_에도_날_설레게_했던
                        내_안의_그_무언가는_어느_별에_묻혔나
                        가끔_울리는_전화벨소리_두근거리며_열어보면
                        역시_똑같은_이상한_광고_메세지일뿐야
                        이제_여기_현실은_삼류영화속_너무_뻔한_일들의_연속이야
                        징그러운_일상은_멈춰_세우고_어디론가_도망갈까
                        ...
                        내_안의_그_무언가는_어느_별에_묻혔나
                        찬란하게_빛나던_내_모습은_어디로_날아갔을까_어느_별로
                        작은_일에도_날_설레게_했던_내_안의_그_무언가는_어느 별에
                        거칠_것이_없었던_내_모습은_어디로_사라졌을까_어느_틈에
                        작은_일에도_늘_행복했었던
